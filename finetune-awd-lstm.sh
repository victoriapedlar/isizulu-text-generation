...
python3 -u awd_lstm/finetune.py \
    ...
    --nonmono 8 \
    --cuda \
    --save models/awd_lstm/_emsize_800_nhid_1150_nlayers_3_lr_30.0_wdc_1.2e-06_clip_0.25_epochs_500_bsz_32_bptt_70_dropout_0.7_dropouth_0.2_dropouti_0.1_dropoute_0.1_wdrop_0.2_seed_1882_patience_3_when_[40, 80, 120, 160].pt \
    --when 40 80 120 160 \
