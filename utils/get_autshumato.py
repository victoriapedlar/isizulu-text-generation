...
parser = argparse.ArgumentParser(description="Download Autshumato dataset (isiZulu).")
parser.add_argument(
    "--output_dir",
    required=True,
...
for url, file_name, output_name, lines_to_remove in datasets:
    ...
    sentences = utils.clean_sentences(
        sentences, min_length=3, lines_to_remove=lines_to_remove
    )
...
print(
    "Autshumato datasets provided under Creative Commons Attribution Non-Commercial ShareAlike, "
